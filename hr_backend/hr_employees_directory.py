...
def _compute_employee_stats() -> Dict[str, Any]:
    ...
    roles = ["agent", "manager", "admin", "executive", "inventory"]
    by_role = {r: users_col.count_documents({"role": r}) for r in roles}
...
def employees():
    ...
    roles = ["All Roles", "Agent", "Manager", "Admin", "Executive", "Inventory"]
