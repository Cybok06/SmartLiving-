...
from card_tracker import card_tracker_bp
from admin_cards_dashboard import admin_cards_dashboard_bp
...
app.register_blueprint(card_tracker_bp)
app.register_blueprint(admin_cards_dashboard_bp)
